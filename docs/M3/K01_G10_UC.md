...
| *KF21* | *R31, R32* | *Sistem harus menyediakan fitur registrasi agar pelanggan dapat mengakses layanan, riwayat transaksi, dan juga mengajukan keluhan melalui formulir pengaduan* |
| *...* | *...* | *...* |
