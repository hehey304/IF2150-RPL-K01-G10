...
| A08 | _Pengaturan Kuota_ | _Sistem menyediakan antarmuka kepada restoran untuk mengonfigurasi kuota antrean_ | _US-09_|
| ... | ... | ... | ... |
...
| *KNF13*|*R02, R05*|*Ergonomy*|Sistem memungkinkan pengguna baru untuk mengoperasikan alur pencarian hingga mendapat tiket antrean dan memantau antrean dengan mudah, yakni maksimal 8 menit tanpa memiliki pengetahuan awal tentang aplikasi.|
| ... | ... | ... | ... |
