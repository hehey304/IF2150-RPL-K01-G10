...
| US-08 | _Restoran_ | _Melakukan dequeue antrian ketika pelanggan sudah ada_ | _Pelanggan berikutnya bisa dipanggil_ |
| US-09 | _Restoran_ | _Mengupdate kuota antrian dari restoran_ | _Restoran tidak kewalahan menangani pelanggan yang mengantri_ |
| ... | ... | ... | ... |
...
| A08 | _Pengaturan Kuota_ | _Sistem membantu restoran mengatur kuota antrian_ | _US-09_|
| ... | ... | ... | ... |
...
| *R02* | *A01* | *System* | *Sistem hanya menampilkan restoran yang sudah disetujui oleh admin dengan informasi rating, gambar-gambar lokasi, serta review restoran.* | *Ya* |
...
| *R07* | *A03* | *User* | *Pengguna dapat memilih daftar menu makanan dan menentukan jumlah pesanan untuk antriannya. Pesanan dapat berupa booking tempat saja atau sekaligus dengan pre-order makanan.* | *Ya* |
| *R08* | *A03* | *Business* | *Pemesanan menu hanya dapat diproses apabila stok menu di restoran masih tersedia* | *Ya* |
| *R09* | *A03* | *System* | *Sistem menyimpan data pesanan dengan ID tiket antrian pengguna* | *Ya* |
| *R10* | *A04* | *User* | *Pengguna dapat memilih metode pembayaran digital (e-wallet, QRIS, transfer bank, virtual account) dan menyelesaikan pembayaran* | *Ya* |
| *R11* | *A04* | *Business* | *Pesanan harus terkonfirmasi lunas terlebih dahulu sebelum diteruskan ke dapur dan mendapatkan nomor antrian* | *Ya* |
| *R12* | *A04* | *System* | *Sistem harus terintegrasi dengan payment gateway untuk memvalidasi status transaksi* | *Ya* |
| *R13* | *A05* | *User* | *Pengguna menerima konfirmasi tiket antrian resmi beserta ringkasan menu yang sudah dibayarkan* | *Ya* |
| *R14* | *A05* | *System* | *Sistem memasukkan rincian pesanan dan nomor urut atau ID pesanan ke dalam antrean restoran di database* | *Ya* |
| *R15* | *A06* | *User* | *Pihak restoran dapat mengisi formulir pendaftaran kemitraan, profil restoran, dan daftar menu* | *Ya* |
| *R16* | *A06* | *User* | *Admin dapat meninjau, menyetujui, atau menolak pengajuan pendaftaran restoran baru* | *Ya* |
| *R17* | *A06* | *Business* | *Restoran baru wajib melalui terifikasi admin sebelum ditampilkan ke publik* | *Ya* |
| *R18* | *A06* | *System* | *Sistem menyimpan data input pendaftaran restoran dengan dan mengirimkan notifikasi persetujuan ke email restoran jika diterima* | *Ya* |
| *R19* | *A07* | *User* | *Restoran bisa melakukan dequeue pada antrian di restorannya sendiri* | *Ya* |
| *R20* | *A07* | *System* | *Antrian yang baru harus ditampilkan secara spontan pada pengguna pelanggan maupun restoran setelah dilakukan dequeue* | *Ya* |
| *R21* | *A08* | *User* | *Restoran bisa mengubah jumlah kuota dari pelanggan yang melakukan antrian* | *Ya* |
| *R22* | *A08* | *System* | *Jumlah kuota baru langsung diberlakukan pada sistem booking pelanggan* | *Ya* |
| ... | ... | ... | ... | ... |
...
| *KF03* | *R04, R05* | *Selama pelanggan berada dalam antrian, sistem harus menampilkan informasi antrian pada pelanggan.* |
| *KF04* | *R06* | *Sistem harus menyediakan fitur menghapus pelanggan yang terdepan dan memperbarui antrian* |
| *KF05* | *R07* | *Sistehm harus menyediakan fitur dua mode pemesanan: booking tempat maupun pre-order* |
| *KF06* | *R08* | *Ketika pelanggan memesan suatu produk, sistem memeriksa apakah pesanan pre-order mampu dipenuhi oleh stok dalam restoran* |
| *KF07* | *R09, R14* | *Ketika pesanan berhasil dilakukan, sistem harus menyimpan data pesanan dan antrian dengan ID tiket antrian pengguna* |
| *KF08* | *R10* | *Jika tersedia berbagai metode pembayaran seperti QRIS dan virtual account, sistem harus bisa memproses sistem pembayaran menggunakan metode-metode tersebut* |
| *KF09* | *R11, R12* | *Ketika pelanggan melakukan pembayaran, sistem harus memverifikasi pembayaran* |
| *KF10* | *R13* | *Ketika pesanan sudah selesai dilakukan, sistem harus menampillkan data pesanan pada pelanggan* |
| *KF11* | *R15* | *Ketika restoran selesai mendaftar, sistem harus menyimpan data restoran dalam database* |
| *KF12* | *R16,R17* | *Sistem harus memungkinkan admin untuk menerima atau menolak restoran* |
...
| *KF13* | *R19, R20* | *Ketika restoran melakukan dequeue pada antrian, antrian yang lama harus diperbarui pada pelanggan* |
| *KF14* | *R21, R22* | *Ketika restoran mengubah jumlah kuota antrian, kuota yang baru harus dimunculkan pada pelanggan* |
| ... | ... | ... |
...
| *KNF03* | *R04* | *Reliability* | *Nomor antrian yang diberikan ke pengguna harus semuanya berbeda dan tidak boleh ada yang sama.* |
| *KNF04* | *R04* | *Ergonomy* | *Tampilan nomor antrian harus minimalis dan nyaman untuk dilihat.* |
| *KNF05* | *R05* | *Availability* | *Sistem harus dapat menampilkan nomor antrian setiap saat setelah diberikan ke pengguna.* |
