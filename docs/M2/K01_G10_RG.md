...
| *C* | *Penambahan Kebutuhan Fungsional KF19, KF20, dan KF21* |
| ... | |
...
| US-10 | _Pelanggan_ | _Mendaftar akun baru dan melakukan proses login ke dalam sistem_ | _Dapat mengakses website, kemudian agar data antrean, identitas profil, dan riwayat pesanan tersimpan dengan aman_ |
| US-11 | _Pelanggan_ | _Mengajukan laporan keluhan atas transaksi dan menerima solusi atau tanggapan resmi dari pihak platform_ | _Masalah pesanan atau kendala antrean yang dialami terselesaikan secara jelas dan adil_ |
| ... | ... | ... | ... |
...
| *R09* | *A03* | *User* | *Pengguna dapat mengambil nomor antrean sekaligus dengan memesan makanan dan/atau minumannya.* | *Ya* |
...
| *R29* | *A10* | *User* | *Admin platform dapat meninjau, mengelola, dan memberikan respons resmi terhadap keluhan transaksi yang diajukan pelanggan* | *Ya* |
| *R30* | *A06* | *User* | *Admin platform dapat menonaktifkan atau menghapus akun mitra restoran dari sistem apabila melanggar ketentuan operasional atau memutus kerja sama* | *Ya* |
| *R31* | *A09* | *User* | *Pelanggan dapat melakukan registrasi akun baru serta autentikasi (login) ke dalam sistem untuk mengakses layanan dan riwayat transaksi* | *Ya* |
| *R32* | *A10* | *System* | *Pelanggan dapat mengajukan laporan keluhan atau aduan ketidaksesuaian pesanan melalui formulir pengaduan pada sistem* | *Ya* |
| ... | ... | ... | ... | ... |
