...
| A08 | _Pengaturan Kuota_ | _Sistem membantu restoran melakukan dequeue ketika pelanggan sudah datang_ | _US-09_|
| ... | ... | ... | ... |
...
| *R02* | *A01* | *Business* | *Sistem hanya menampilkan restoran yang sudah disetujui oleh admin dengan informasi rating, gambar-gambar lokasi, serta review restoran.* | *Ya* |
...
| :--- | :--- | :--- |
| *KF01* | *R01* | *Perangkat lunak dapat menyediakan fitur pencarian restoran viral berdasarkan nama restoran, rating, atau jenis makanan* |
| *KF02* | *R02, R03* | *Perangkat lunak dapat menampilkan daftar restoran yang sudah disetujui oleh admin* |
| *KF03* | *R04* | *Perangkat lunak dapat menampilkan antrian untuk setiap restoran yang terdaftar dalam database* |
| *KF04* | *R05* | *Perangkat lunak dapat mempertahankan akurasi antrian dari setiap restoran yang terdaftar* |
| *KF05* | *R06* | *Perangkat lunak dapat menyediakan fitur menghapus pelanggan yang terdepan dan memperbarui antrian* |
| *KF06* | *R07* | *Perangkat lunak dapat menyediakan fitur dua mode pemesanan: booking tempat maupun pre-order* |
| *KF07* | *R08* | *Perangkat lunak memeriksa apakah pesanan pre-order mampu dipenuhi oleh stok dalam restoran* |
| ... | ... | ... |
