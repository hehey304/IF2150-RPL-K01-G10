...
| *KF06* | *R09* | *Ketika pelanggan memesan barang, sistem harus memeriksa stok menu di restoran* |
| *KF07* | *R10* | *Sistem harus menyesuaikan enqueue dengan mode pemesanan* |
| *KF08* | *R11, R17* | *Ketika pesanan berhasil dilakukan, sistem harus menyimpan data pesanan dan antrean dengan ID tiket antrean pengguna* |
| *KF09* | *R12* | *Jika tersedia berbagai metode pembayaran seperti QRIS dan virtual account, sistem harus bisa memproses sistem pembayaran menggunakan metode-metode tersebut* |
| *KF10* | *R13, R14* | *Ketika pelanggan melakukan pembayaran, sistem harus memverifikasi pembayaran* |
| *KF11* | *R16* | *Ketika pesanan sudah selesai dilakukan, sistem harus menampillkan data pesanan pada pelanggan* |
| *KF12* | *R19* | *Ketika restoran selesai mendaftar, sistem harus menyimpan data restoran dalam database* |
| *KF13* | *R20,R21* | *Sistem harus memungkinkan admin untuk menerima atau menolak restoran* |
| *KF14* | *R22* | *Jika tersedia notifikasi penerimaan atau penolakan, sistem harus mengirimkan pesan pada email restoran yang mendaftarkan diri* |
| *KF15* | *R23, R24* | *Ketika restoran melakukan dequeue pada antrean, antrean yang lama harus diperbarui pada pelanggan* |
| *KF16* | *R25, R26* | *Ketika restoran mengubah jumlah kuota antrean, kuota yang baru harus dimunculkan pada pelanggan* |
| ... | ... | ... |
