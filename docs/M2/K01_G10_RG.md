...
| *R08* | *A03* | *User* | *Pengguna dapat memilih untuk mengambil nomor antrean saja atau sekaligus dengan pre-order makanan.* | *Ya* |
...
| *R11* | *A03* | *Business* | *Tergantung ketersediaan restoran, pelanggan dapat melakukan reservasi sejak maksimal satu minggu sebelum tanggal mendatangi restoran* | *Ya* |
| *R12* | *A03* | *System* | *Sistem menyimpan data pesanan dengan ID tiket antrean pengguna* | *Ya* |
| *R13* | *A04* | *User* | *Pengguna dapat memilih metode pembayaran digital (e-wallet, QRIS, transfer bank, virtual account) dan menyelesaikan pembayaran* | *Ya* |
| *R14* | *A04* | *Business* | *Pesanan harus terkonfirmasi lunas terlebih dahulu sebelum diteruskan ke dapur dan mendapatkan nomor antrean* | *Ya* |
| *R15* | *A04* | *System* | *Sistem harus terintegrasi dengan payment gateway untuk memvalidasi status transaksi* | *Ya* |
| *R16* | *A04* | *Business* | *Pengelola platform dan mitra restoran wajib menetapkan Standard Operating Procedure (SOP) pengembalian dana (refund) dan ganti rugi fisik secara tertulis untuk mematuhi UU No. 8 Tahun 1999 tentang Perlindungan Konsumen jika pesanan batal akibat dapur tutup mendadak* | *Tidak* |
| *R17* | *A05* | *User* | *Pengguna menerima konfirmasi tiket antrean resmi beserta ringkasan menu yang sudah dibayarkan* | *Ya* |
| *R18* | *A05* | *System* | *Sistem memasukkan rincian pesanan dan nomor urut atau ID pesanan ke dalam antrean restoran di database* | *Ya* |
| *R19* | *A05* | *Business* | *Pengelola platform dilarang membagikan data pelanggan ke pihak resto atau pihak ketiga tanpa persetujuan tertulis dari pelanggan sesuai UU No. 27 Tahun 2022 (UU PDP)* | *Tidak* |
| *R20* | *A06* | *User* | *Pihak restoran dapat mengisi formulir pendaftaran kemitraan, profil restoran, dan daftar menu* | *Ya* |
| *R21* | *A06* | *User* | *Admin dapat meninjau, menyetujui, atau menolak pengajuan pendaftaran restoran baru* | *Ya* |
| *R22* | *A06* | *Business* | *Restoran baru wajib terverifikasi admin sebelum dapat ditampilkan ke publik* | *Ya* |
| *R23* | *A06* | *System* | *Sistem menyimpan data input pendaftaran restoran dengan dan mengirimkan notifikasi persetujuan ke email restoran jika diterima* | *Ya* |
| *R24* | *A07* | *User* | *Restoran bisa melakukan dequeue pada antrean di restorannya sendiri* | *Ya* |
| *R25* | *A07* | *System* | *Antrean yang baru harus ditampilkan secara spontan pada pengguna pelanggan maupun restoran setelah dilakukan dequeue* | *Ya* |
| *R26* | *A08* | *User* | *Restoran bisa mengubah jumlah kuota dari pelanggan yang melakukan antrean* | *Ya* |
| *R27* | *A08* | *System* | *Jumlah kuota baru langsung diberlakukan pada sistem booking pelanggan* | *Ya* |
| ... | ... | ... | ... | ... |
