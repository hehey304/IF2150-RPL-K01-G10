...
| *C49* | *RegistrasiPage* | *Antarmuka untuk melakukan registrasi sebagai pelanggan, restoran, atau admin (Boundary Class)* | *UC10, UC11* |
| *C40* | *LoginPage* | *Antarmuka puntuk masuk sebagai pelanggan, restoran, atau admin (Boundary Class)* | *UC10, UC11* |
...
| *C28* | *Autentikasi Controller* | *-* | *createAccount(), validation()* |
