...
| *C03* | *Keranjang* | *Menyimpan sementara item yang dipilih sebelum checkout.* | *UC02* |
...
| *C07* | *RiwayatTransaksi* | *Menyimpan catatan transaksi beserta status yang dikembalikan payment gateway.* | *UC03, UC05* |
| *C08* | *Restoran* | *Menyimpan data profil restoran yang mengelola antrean.* | *UC01, UC02, UC04, UC06, UC07, UC08, UC09, UC10* |
| *C09* | *Menu* | *Menyimpan detail hidangan, harga, kategori, dan ketersediaan stok bahan/porsi.* | *UC01, UC02, UC08* |
| *C10* | *Antrean* | *Menyimpan koleksi antrean pelanggan pada suatu restoran, status urutan antrean, serta data pesanan pre-order jika ada.* | *UC02, UC06* |
| *C11* | *TiketAntrean* | *Mengelola ID tiket antrean, nomor urut panggilan, alokasi meja, dan estimasi waktu tunggu.* | *UC02, UC03, UC06, UC07, UC09* |
| *C12* | *«abstract» MetodePembayaran* | *Kelas abstrak yang mendefinisikan antarmuka dan protokol pembayaran ke Payment Gateway.* | *UC02* |
| *C13* | *QRIS* | *Subkelas turunan MetodePembayaran untuk pembayaran kode QR dinamis* | *UC02* |
| *C14* | *VirtualAccount* | *Subkelas turunan MetodePembayaran untuk transfer perbankan berbasis kode bayar.* | *UC02* |
| *...* | *...* | *...* | *...* |
