...
| :--- | :--- | :--- | :--- |
| *C01* | *Pelanggan* | *Menyimpan data/identitas pelanggan yang menggunakan sistem, melakukan pemesanan, memantau antrean, dan menyampaikan keluhan.* | *UC01, UC02, UC03, UC06, UC10, UC13* |
| *C02* | *Restoran* | *Menyimpan data profil dan identitas restoran yang mendaftar sebagai mitra serta mengelola antrean, kuota, meja, dan menu.* | *UC01, UC02, UC04, UC06, UC07, UC08, UC09, UC10, UC15* |
| *C03* | *Menu* | *Menyimpan informasi menu makanan seperti nama, harga, deskripsi, kategori, dan stok/ketersediaan.* | *UC01, UC02, UC04, UC08* |
| *C04* | *Antrean* | *Menyimpan koleksi antrean pelanggan, urutan antrean, status antrean, dan informasi terkait pesanan pre-order.* | *UC01, UC03, UC06, UC09* |
| *C05* | *Keranjang* | *Menyimpan sementara item makanan yang dipilih pelanggan sebelum proses checkout.* | *UC02* |
| *C06* | *Pesanan* | *Menyimpan data pesanan, rincian menu, total harga, mode pemesanan, dan status pesanan/pembayaran.* | *UC02, UC03, UC06, UC09* |
| *C07* | *MetodePembayaran* | *Kelas abstrak yang mendefinisikan antarmuka dan protokol pembayaran melalui Payment Gateway.* | *UC02* |
| *C08* | *QRIS* | *Subkelas MetodePembayaran yang merealisasikan pembayaran menggunakan kode QR dinamis.* | *UC02* |
| *C09* | *VirtualAccount* | *Subkelas MetodePembayaran untuk pembayaran melalui transfer perbankan menggunakan kode bayar.* | *UC02* |
| *C10* | *RiwayatTransaksi* | *Menyimpan catatan transaksi, jumlah pembayaran, waktu transaksi, dan status pelunasan yang diterima dari Payment Gateway.* | *UC02* |
| *C11* | *TiketAntrean* | *Mengelola ID tiket, nomor urut panggilan, tipe antrean, waktu penerbitan, status antrean, alokasi meja, dan estimasi waktu tunggu.* | *UC02, UC03, UC06, UC07, UC09* |
| *C12* | *Pemantau Antrean Controller* | *Memproses pembacaan data antrean dan memperbarui tampilan status antrean pelanggan.* | *UC03* |
| *C13* | *Halaman Status Antrean* | *Antarmuka yang digunakan pelanggan untuk melihat status antrean secara real-time.* | *UC03* |
| *C14* | *PengajuanMitra* | *Menyimpan data dan status pengajuan pendaftaran restoran sebagai mitra.* | *UC04, UC05* |
| *C15* | *DokumenVerifikasi* | *Menyimpan dokumen perizinan yang diunggah dalam proses pendaftaran mitra restoran.* | *UC04* |
| *C16* | *Admin* | *Menyimpan data administrator yang melakukan verifikasi pengajuan restoran, meninjau keluhan, dan mengelola penghapusan restoran.* | *UC05, UC10, UC14, UC15* |
| *C17* | *NotifikasiEmail* | *Mengirimkan notifikasi hasil verifikasi pendaftaran restoran melalui email.* | *UC05* |
| *C18* | *Kelola Antrean* | *Mengelola proses dequeue manual/otomatis serta pembaruan status antrean.* | *UC06* |
| *C19* | *Konfirmasi Dequeue* | *Antarmuka berupa dialog/pop-up untuk mengonfirmasi atau membatalkan proses dequeue.* | *UC06* |
| *C20* | *Dashboard Antrean* | *Antarmuka untuk menampilkan daftar antrean restoran dan melakukan dequeue.* | *UC06* |
| *C21* | *Kuota* | *Menyimpan konfigurasi maksimum antrean, kapasitas meja, dan status antrean.* | *UC07* |
| *C22* | *Pengaturan Kuota Controller* | *Mengelola validasi input serta penyimpanan pengaturan kuota dan meja.* | *UC07* |
| *C23* | *Pengaturan Kuota* | *Antarmuka untuk menampilkan dan menerima input pengaturan kuota antrean serta kapasitas meja.* | *UC07* |
| *C24* | *Pengaturan Menu* | *Antarmuka untuk menampilkan daftar menu serta formulir tambah/edit menu.* | *UC08* |
| *C25* | *Kelola Menu Controller* | *Mengelola logika bisnis pemrosesan data menu dan pembaruan stok.* | *UC08* |
| *C26* | *Akun* | *Menyimpan kredensial akun berupa username dan password serta menangani validasi akun.* | *UC10, UC11* |
| *C27* | *Halaman Profil* | *Antarmuka profil pengguna yang menyediakan akses untuk memicu proses logout.* | *UC12* |
| *C28* | *Konfirmasi Logout* | *Dialog konfirmasi untuk memastikan pengguna ingin mengakhiri sesi login.* | *UC12* |
| *C29* | *Autentikasi Controller* | *Menangani proses logout, pemutusan sesi, dan penghapusan token login pengguna.* | *UC12* |
| *C30* | *Sesi Pengguna* | *Menyimpan token autentikasi aktif, status login, dan validasi sesi pengguna.* | *UC12* |
| *C31* | *Pengguna* | *Menyimpan kredensial serta hak akses/role pengguna yang sedang login.* | *UC12* |
| *C32* | *Keluhan* | *Menyimpan isi, waktu pengiriman, dan status keluhan pelanggan.* | *UC13, UC14* |
| *C33* | *Dashboard Kelola Restoran* | *Antarmuka admin yang menampilkan daftar restoran mitra yang terdaftar.* | *UC15* |
| *C34* | *Konfirmasi Hapus Restoran* | *Dialog konfirmasi untuk memastikan keputusan admin sebelum restoran dihapus.* | *UC15* |
| *C35* | *Kelola Data Restoran* | *Mengelola logika bisnis penonaktifan dan penghapusan data restoran dari database.* | *UC15* |
...
| *C02* | *Restoran* | *Menyimpan data profil restoran yang mengelola antrean.* |
| *C03* | *Menu* | *Menyimpan data entitas item menu makanan, harga, serta informasi ketersediaannya.* |
| *C04* | *Antrean* | *Menyimpan koleksi antrean pelanggan pada suatu restoran, status urutan antrean, serta data pesanan pre-order jika ada.* |
| *...* | *...* | *...* |

#### Diagram Kelas

<p align="center">
<img alt="Class Diagram UC01" src="./assets/diagram/Kelas Diagram-UC01.png" width="70%">
</p>
<p align="center">
...
| :--- | :--- | :--- |
| *C01* | *Pelanggan* | *Menyimpan data akun pelanggan yang membuat pesanan.* |
| *C02* | *Keranjang* | *Menyimpan sementara item yang dipilih sebelum checkout.* |
| *C03* | *Menu* | *Menyimpan data entitas item menu makanan, harga, serta informasi ketersediaannya.* |
| *C04* | *Pesanan* | *Menyimpan data pesanan beserta status pembayarannya.* |
| *C05* | *«abstract» MetodePembayaran* | *Kelas abstrak yang mendefinisikan antarmuka dan protokol pembayaran ke Payment Gateway.* |
| *C06* | *QRIS* | *Subkelas turunan MetodePembayaran untuk pembayaran kode QR dinamis* |
| *C07* | *VirtualAccount* | *Subkelas turunan MetodePembayaran untuk transfer perbankan berbasis kode bayar.* |
| *...* | *...* | *...* |

#### Diagram Kelas

<p align="center">
<img alt="Class Diagram UC01" src="./assets/diagram/Diagram Kelas-UC02.drawio.png" width="70%">
</p>
<p align="center">
...
| *C02* | *Keranjang* | *idKeranjang, daftarMenu, totalEstimasiHarga* | *tambahItem(), hapusItem(), hitungTotal(), kosongkanKeranjang()* |
| *C03* | *Menu* | *menuId, namaMenu, harga, deskripsiMenu, stok* | *cekStok(), kurangiStok()* |
| *C04* | *Pesanan* | *idPesanan, modePemesanan, jumlahRombongan, tanggalBooking, slotWaktuBooking, totalHarga, statusPemesanan* | *validasiBooking(), buatTagihan(), batalkanPesanan(), updateStatus()* |
| *C05* | *TiketAntrean* | *idTiket, nomorUrut, tipeAntrean, waktuTerbit, statusAntrean* | *generateNomorAntrean(), cetakRincianTiket()* |
| *C06* | *«abstract» MetodePembayaran* | *idPembayaran, batasWaktuBayar, statusPembayaran* | *buatTagihan(), verifikasiPembayaran(), cekTimeout()* |
| *C07* | *QRIS* | *qrCodeString, urlGambarQR* | *generateQR(), verifikasiPembayaran()* |
| *C08* | *VirtualAccount* | *nomorVA, namaBank* | *generateNomorVA(), verifikasiPebayaran()* |
| *C09* | *RiwayatTransaksi* | *idTransaksi, tanggalTransaksi, jumlahDibayar, statusPelunasan* | *catatLogTransaksi(), getBuktiPembayaran()* |
| *...* | *...* | *...* | *...* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C01* | *Pelanggan* | *Menyimpan data akun pelanggan yang sedang memantau antrean.* |
| *C02* | *Antrean* | *Menyimpan data tiket antrean, nomor urut, sisa antrean, dan status panggilan pelanggan.* |
| *C03* | *Pesanan* | *Menyimpan data rincian pesanan menu dan total pembayaran yang terikat dengan nomor antrean.* |
| *C04* | *Pemantau Antrean Controller* | *Kontroler sistem yang memproses pembacaan data antrean dan memperbarui tampilan status antrean pelanggan.* |
| *C05* | *Halaman Status Antrean* | *Antarmuka layar yang digunakan pelanggan untuk melihat informasi status urutan antrean secara real-time.* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C01* | *Pelanggan* | *idPelanggan, nama, noHp* | *lihatStatusAntrean()* |
| *C02* | *Antrean* | *idTiket, nomorAntrean, sisaAntrean, status* | *getDetailAntrean(), updateStatus()* |
| *C03* | *Pesanan* | *idPesanan, totalHarga, modePemesanan* | *getDetailPesanan()* |
| *C04* | *Pemantau Antrean Controller* | *idAntrean* | *getStatusAntrean(), updateTampilanAntrean()* |
| *C05* | *Halaman Status Antrean* | *idAntrean, statusAntrean, sisaAntrean* | *tampilkanStatusAntrean(), renderData()* |
...
#### Diagram Kelas
<p align="center">
<img alt="Class Diagram UC01" src="./assets/diagram/Diagram-PM.png" width="70%">
</p>
<p align="center">
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C01* | *Restoran* | *Mengakses dan melihat status antrean pada dashboard antrean.* |
| *C02* | *Antrean* | *Menyimpan data antrean* |
| *C03* | *Pesanan* | *Menyimpan detail pesanan pada pelanggan* |
| *...* | *...* | *...* |

#### Diagram Kelas

<p align="center">
<img alt="Class Diagram UC09" src="." width="70%">
</p>
<p align="center">
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C01* | *Restoran* | *restoranId, namaRestoran* | *showDashboard()* |
| *C02* | *Antrean* | *antreanId, restoranId, noAntrean, statusAntrean* | *getQueueStatus(), updateMenu()* |
| *C03* | *Pesanan* | *Idpesanan, antreanId, totalHarga* | *showOrderDetails()* |
| *...* | *...* | *...* | *...* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C01* | *Akun* | *Menyimpan username dan password* |
| *C02* | *Pelanggan* | *Menyimpan data identitas pelanggan* |
| *C03* | *Restoran* | *Menyimpan data identitas restoran* |
| *C04* | *Admin* | *Menyimpan data identitas admin* |
| *...* | *...* | *...* |
...
<p align="center">
<i>Gambar 9. Diagram Kelas Use Case UC10</i>
</p>
<br>
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C01* | *Akun* | *akunId, username, password* | *createAccount(), validation()* |
| *C02* | *Pelanggan* | *idPelanggan, idAkun, namaPelanggan, email* | *accountRegister()* |
| *C03* | *Restoran* | *idRestoran, idAkun, namaRestoran* | *accountRegister()* |
| *C04* | *Admin* | *idAdmin, idAkun, namaAdmin* | *accountRegister()* |
| *...* | *...* | *...* | *...* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C01* | *Akun* | *Mengakses dan melihat status antrean pada dashboard antrean.* |
| *...* | *...* | *...* |
...
<p align="center">
<i>Gambar 9. Diagram Kelas Use Case UC11</i>
</p>
<br>
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C01* | *Akun* | *idAkun, username, password* | *validation()* |
| *...* | *...* | *...* | *...* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C01* | *Halaman Profil* | *Antarmuka layar profil pengguna yang menyediakan tombol untuk memicu fungsi keluar akun.* |
| *C02* | *Konfirmasi Logout* | *Dialog konfirmasi yang meminta kepastian pengguna sebelum sesi login diakhiri.* |
| *C03* | *Autentikasi Controller* | *Kontroler sistem yang menangani logika pemutusan sesi dan penghapusan token login pengguna.* |
| *C04* | *Sesi Pengguna* | *Menyimpan token autentikasi aktif, status login, dan mengelola validasi sesi pengguna.* |
| *C05* | *Pengguna* | *Menyimpan kredensial dan hak akses akun (Pelanggan, Restoran, atau Admin) yang sedang login.* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C01* | *Halaman Profil* | *idPengguna, namaUser* | *tekanTombolLogout()* |
| *C02* | *Konfirmasi Logout* | *pesanKonfirmasi* | *konfirmasiYa(), konfirmasiBatal()* |
| *C03* | *Autentikasi Controller* | *tokenManager* | *processLogout(), handleSessionDeletion()* |
| *C04* | *Sesi Pengguna* | *idSesi, token, statusAktif* | *hapusSesi(), validateToken()* |
| *C05* | *Pengguna* | *idPengguna, email, role* | *logout()* |
...
<p align="center">
<img alt="Class Diagram UC01" src="./assets/diagram/Diagram-KL.png" width="70%">
</p>
<p align="center">
...
| :--- | :--- | :--- |
| *C-KL02* | *Keluhan* | *Menyimpan isi, waktu, dan status keluhan pelanggan.* |
| *C-KL03* | *Admin* | *Aktor yang meninjau daftar keluhan pelanggan.* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C-KL02* | *Keluhan* | *status* | *lihatKeluhan()* |
| *C-KL03* | *Admin* | *idAdmin, nama* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C01* | *Dashboard Kelola Restoran* | *Antarmuka layar admin yang menampilkan daftar seluruh restoran mitra terdaftar.* |
| *C02* | *Konfirmasi Hapus Restoran* | *Dialog konfirmasi untuk memastikan keputusan admin sebelum menghapus data restoran.* |
| *C03* | *Kelola Data Restoran* | *Kontroler sistem yang mengeksekusi logika bisnis penonaktifan dan penghapusan data restoran dari database.* |
| *C04* | *Restoran* | *Menyimpan data profil mitra restoran, status operasional, dan status kemitraan.* |
| *C05* | *Admin* | *Menyimpan data profil administrator yang memicu aksi penghapusan restoran.* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C01* | *Dashboard Kelola Restoran* | *daftarRestoran, kataKunci* | *pilihRestoran(), klikHapusRestoran()* |
| *C02* | *Konfirmasi Hapus Restoran* | *idRestoran, pesanPeringatan* | *setujuiPenghapusan(), batalHapus()* |
| *C03* | *Kelola Data Restoran* | *idRestoran* | *hapusDataRestoran(), nonaktifkanRelasiMenu()* |
| *C04* | *Restoran* | *idRestoran, namaRestoran, statusAktif* | *setSoftDelete(), purgeData()* |
| *C05* | *Admin* | *idAdmin, namaAdmin* | *konfirmasiPenghapusan()* |
