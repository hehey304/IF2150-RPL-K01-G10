...
| *C02* | *Restoran* | *Menyimpan data profil dan identitas restoran yang mendaftar sebagai mitra serta mengelola antrean, kuota, meja, dan menu. (Entity Class)* | *UC01, UC02, UC04, UC06, UC07, UC08, UC09, UC10, UC15* |
...
| *C07* | *MetodePembayaran* | *Kelas abstrak yang mendefinisikan antarmuka dan protokol pembayaran melalui Payment Gateway.(Boundary Class)* | *UC02* |
| *C08* | *RiwayatTransaksi* | *Menyimpan catatan transaksi, jumlah pembayaran, waktu transaksi, dan status pelunasan yang diterima dari Payment Gateway.(Boundary Class)* | *UC02* |
| *C09* | *TiketAntrean* | *Mengelola ID tiket, nomor urut panggilan, tipe antrean, waktu penerbitan, status antrean, alokasi meja, dan estimasi waktu tunggu. (Boundary Class)* | *UC02, UC03, UC06, UC07, UC09* |
...
| *C12* | *PengajuanMitra* | *Menyimpan data dan status pengajuan pendaftaran restoran sebagai mitra. (Entity Class)* | *UC04, UC05* |
...
| *C15* | *NotifikasiEmail* | *Mengirimkan notifikasi hasil verifikasi pendaftaran restoran melalui email. (Boundary Class)* | *UC05* |
...
| *C17* | *KonfirmasiDequeue* | *Antarmuka berupa dialog/pop-up untuk mengonfirmasi atau membatalkan proses dequeue.* | *UC06* |
| *C18* | *KelolaAntrean* | *Antarmuka untuk menampilkan antrean yang bisa diatur. (Boundary Class)* | *UC06* |
| *C19* | *DashboardAntrean* | *Antarmuka untuk menampilkan daftar antrean restoran dan melakukan dequeue. (Boundary Class)* | *UC06* |
...
| *C22* | *PengaturanKuota* | *Antarmuka untuk menampilkan dan menerima input pengaturan kuota antrean serta kapasitas meja. (Boundary Class)* | *UC07* |
| *C23* | *PengaturanMenu* | *Antarmuka untuk menampilkan daftar menu serta formulir tambah/edit menu. (Boundary Class)* | *UC08* |
...
| *C26* | *HalamanProfil* | *Antarmuka profil pengguna yang menyediakan akses untuk memicu proses logout. (Boundary Class)* | *UC12* |
| *C27* | *KonfirmasiLogout* | *Dialog konfirmasi untuk memastikan pengguna ingin mengakhiri sesi login. (Boundary Class)* | *UC12* |
...
| *C32* | *DashboardKelolaRestoran* | *Antarmuka admin yang menampilkan daftar restoran mitra yang terdaftar. (Boundary Class)* | *UC15* |
| *C33* | *KonfirmasiHapusRestoran* | *Dialog konfirmasi untuk memastikan keputusan admin sebelum restoran dihapus. (Boundary Class)* | *UC15* |
...
<p align="center">
<img alt="Class Diagram UC01" src="./assets/diagram/Kelas Diagram-UC01.drawio.png" width="70%">
</p>
<p align="center">
...
| *C09* | *TiketAntrean* | *Menyimpan data spesifik tiket fisik/digital pelanggan, seperti nomor tiket, estimasi waktu dipanggil, dan status tiket saat ini.* |
...
| *C18* | *KelolaAntreanController* | *Mengelola alur pemrosesan dequeue manual/otomatis dan pembaruan status antrean.* |
| *C19* | *KonfirmasiDequeue* | *Antarmuka pengguna berupa pop-up untuk mengonfirmasi atau membatalkan proses dequeue* |
| *C20* | *KelolaAntrean* | *Antarmuka pengguna untuk menampilkan daftar antrean restoran dan melakukan dequeue.* |
...
| *C18* | *KelolaAntreanController* | *timer* | *getAntrean()* | *handleViewDashboard(), handleDequeue(), handleCancelDequeue(), startNoShowTimer(), processAutoDequeue()* |
| *C19* | *KonfirmasiDequeue* | *message* | *showConfirmationModal(), hideModal(), onConfirm(), onCancel()* |
| *C20* | *KelolaAntrean* | *queueListUI* | *displayDashboard(antrean: Antrean), dequeue()* |
...
| *C22* | *PengaturanKuotaController* | *Mengelola validasi input serta penyimpanan data.* |
| *C23* | *PengaturanKuota* | *Antarmuka pengguna untuk menampilkan serta menerima input pengaturan kuota dan meja.* |
...
| *22* | *PengaturanKuotaController* | *kuotaInput, mejaInput* | *displaySettings(), onSaveSettings(), showErrorPeringatan()* |
| *23* | *PengaturanKuota* | *-* | *handleViewSettings(), handleSaveSettings(), validateInput()* |
...
| *C24* | *PengaturanMenu* | *Antarmuka pengguna untuk menampilkan daftar menu serta formulir tambah/edit menu* |
| *C25* | *KelolaMenuController* | *Mengelola logika bisnis pemrosesan data menu dan pembaruan stok.* |
...
| *C24* | *PengaturanMenu* | *menuInput, stokInput, hargaInput* | *displayDaftarMenu(), showFormTambahMenu(), onSaveMenu(), onDeleteMenu()* |
| *C25* | *KelolaMenuController* | *...* | *handleFetchMenu(), handleAddMenu(), handleUpdateMenu(), handleDeleteMenu()* |
...
<p align="center">
<img alt="Class Diagram Keseluruhan" src="./assets/diagram/Diagram Kelas-Utama.png" width="80%">
</p>
<p align="center">
