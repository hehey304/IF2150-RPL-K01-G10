...
| *C10* | *PemantauAntreanController* | *Kontroler sistem yang memproses pembacaan data antrean dan memperbarui tampilan status antrean pelanggan.* |
| *C11* | *HalamanStatusAntrean* | *Antarmuka layar yang digunakan pelanggan untuk melihat informasi status urutan antrean secara real-time.* |
...
| *C10* | *PemantauAntreanController* | *idAntrean* | *getStatusAntrean(), updateTampilanAntrean()* |
| *C11* | *HalamanStatusAntrean* | *idAntrean, statusAntrean, sisaAntrean* | *tampilkanStatusAntrean(), renderData()* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C26* | *HalamanProfil* | *Antarmuka layar profil pengguna yang menyediakan tombol untuk memicu fungsi keluar akun.* |
| *C27* | *KonfirmasiLogout* | *Dialog konfirmasi yang meminta kepastian pengguna sebelum sesi login diakhiri.* |
| *C28* | *AutentikasiController* | *Kontroler sistem yang menangani logika pemutusan sesi dan penghapusan token login pengguna.* |
| *C29* | *SesiPengguna* | *Menyimpan token autentikasi aktif, status login, dan mengelola validasi sesi pengguna.* |
...
| *C32* | *DashboardKelolaRestoran* | *Antarmuka layar admin yang menampilkan daftar seluruh restoran mitra terdaftar.* |
| *C33* | *KonfirmasiHapusRestoran* | *Dialog konfirmasi untuk memastikan keputusan admin sebelum menghapus data restoran.* |
| *C34* | *KelolaDataRestoran* | *Kontroler sistem yang mengeksekusi logika bisnis penonaktifan dan penghapusan data restoran dari database.* |
