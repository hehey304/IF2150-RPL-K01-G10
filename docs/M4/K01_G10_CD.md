...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C02* | *Restoran* | *Mengakses dan melihat status antrean pada dashboard antrean. (Entity Class)* |
| *C04* | *Antrean* | *Menyimpan data antrean. (Entity Class)* |
| *C06* | *Pesanan* | *Menyimpan detail pesanan pada pelanggan. (Entity Class)* |
| *C09* | *TiketAntrean* | *Menyimpan detail tiket antrean pada pelanggan. (Entity Class)* |
| *C16* | *KelolaAntreanController* | *Mengelola logika bisnis terkait antrean. (Controller Class)* |
| *C19* | *Dashboard Antrean* | *Antarmuka pengguna untuk menampilkan daftar antrean restoran. (Boundary Class)* |
| *...* | *...* | *...* |
...
| *C28* | *AutentikasiController* | *Menyimpan username dan password. (Controller Class)* |
| *C29* | *SesiPengguna* | *Menyimpan data identitas sesi pengguna. (Entity Class)* |
| *C30* | *Pengguna* | *Menyimpan data identitas pengguna. (Entity Class)* |
| *C39* | *RegistrasiPage* | *Antarmuka untuk melakukan registrasi sebagai pelanggan, restoran, atau admin. (Boundary Class)* |
| *...* | *...* | *...* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C28* | *AutentikasiController* | *Mengeksekusi logika verifikasi kredensial saat pengguna login. (Controller Class)* |
| *C29* | *SesiPengguna* | *Menyimpan informasi dan token sesi pengguna yang berhasil login dan aktif. (Entity Class)* |
| *C30* | *Pengguna* | *Menyimpan informasi dan kredensial pengguna yang terdaftar (Entity Class)* |
| *C40* | *LoginPage* | *Antarmuka untuk masuk sebagai pelanggan, restoran, atau admin. (Boundary Class)* |
| *...* | *...* | *...* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C01* | *Pelanggan* | *Aktor yang mengirimkan keluhan. (Entity Class)* |
| *C31* | *Keluhan* | *Menyimpan isi, waktu, dan status keluhan pelanggan. (Entity Class)* |
|*C41*|*KeluhanFormPage*|*Antarmuka untuk menyimpan keluhan dari pengguna. (Boundary Class)*|
|*C42*|*KeluhanController*|*Mengatur pengiriman keluhan dan menampilkan keluhan. (Controller Class)*|
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C14* | *Admin* | *Aktor yang meninjau daftar keluhan pelanggan. (Entity Class)* |
| *C31* | *Keluhan* | *Menyimpan isi, waktu, dan status keluhan pelanggan. (Entity Class)* |
|*C42*|*KeluhanController*|*Mengatur pengiriman keluhan dan menampilkan keluhan. (Controller Class)*|
|*C43*|*KeluhanDashboardPage*|*Antarmuka untuk melihat daftar keluhan sebagai admin. (Boundary Class)*|
...
| *C34* | *KelolaDataRestoran* | *Kontroler sistem yang mengeksekusi logika bisnis penonaktifan dan penghapusan data restoran dari database. (Controller Class)* |
