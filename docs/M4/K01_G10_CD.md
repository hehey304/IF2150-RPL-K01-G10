...
| *C01* | *Pelanggan* | *Menyimpan data akun pelanggan yang membuat pesanan.* |
| *C03* | *Menu* | *Menyimpan data entitas item menu makanan, harga, serta informasi ketersediaannya.* |
| *C05* | *Keranjang* | *Menyimpan sementara item yang dipilih sebelum checkout.* |
| *C06* | *Pesanan* | *Menyimpan data pesanan beserta status pembayarannya.* |
| *C07* | *«abstract» MetodePembayaran* | *Kelas abstrak yang mendefinisikan antarmuka dan protokol pembayaran ke Payment Gateway.* |
| *C08* | *QRIS* | *Subkelas turunan MetodePembayaran untuk pembayaran kode QR dinamis* |
| *C09* | *VirtualAccount* | *Subkelas turunan MetodePembayaran untuk transfer perbankan berbasis kode bayar.* 
| *C10* | *RiwayatTransaksi* | *Menyimpan catatan transaksi, jumlah pembayaran, waktu transaksi, dan status pelunasan yang diterima dari Payment Gateway.* |
| *C11* | *TiketAntrean* | *Mengelola ID tiket, nomor urut panggilan, tipe antrean, waktu penerbitan, status antrean, alokasi meja, dan estimasi waktu tunggu.* |
...
| *C07* | *«abstract» MetodePembayaran* | *idPembayaran, batasWaktuBayar, statusPembayaran* | *buatTagihan(), verifikasiPembayaran(), cekTimeout()* |
| *C08* | *QRIS* | *qrCodeString, urlGambarQR* | *generateQR(), verifikasiPembayaran()* |
| *C09* | *VirtualAccount* | *nomorVA, namaBank* | *generateNomorVA(), verifikasiPebayaran()* |
| *C10* | *RiwayatTransaksi* | *idTransaksi, tanggalTransaksi, jumlahDibayar, statusPelunasan* | *catatLogTransaksi(), getBuktiPembayaran()* |
| *C11* | *TiketAntrean* | *idTiket, nomorUrut, tipeAntrean, waktuTerbit, statusAntrean* | *generateNomorAntrean(), cetakRincianTiket()* |
| *...* | *...* | *...* | *...* |
...
| *C04* | *Antrean* | *Menyimpan data tiket antrean, nomor urut, sisa antrean, dan status panggilan pelanggan.* |
| *C06* | *Pesanan* | *Menyimpan data rincian pesanan menu dan total pembayaran yang terikat dengan nomor antrean.* |
| *C12* | *Pemantau Antrean Controller* | *Kontroler sistem yang memproses pembacaan data antrean dan memperbarui tampilan status antrean pelanggan.* |
| *C13* | *Halaman Status Antrean* | *Antarmuka layar yang digunakan pelanggan untuk melihat informasi status urutan antrean secara real-time.* |
...
| *C06* | *Pesanan* | *idPesanan, totalHarga, modePemesanan* | *getDetailPesanan()* |
| *C12* | *Pemantau Antrean Controller* | *idAntrean* | *getStatusAntrean(), updateTampilanAntrean()* |
| *C13* | *Halaman Status Antrean* | *idAntrean, statusAntrean, sisaAntrean* | *tampilkanStatusAntrean(), renderData()* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C02* | *Restoran* | *Menyimpan profil restoran yang mengajukan diri sebagai mitra.* |
| *C03* | *Menu* | *Menyimpan daftar menu yang diajukan bersamaan dengan pendaftaran.* |
| *C14* | *PengajuanMitra* | *Menyimpan data & status pengajuan pendaftaran mitra restoran.* |
| *C15* | *DokumenVerifikasi* | *Menyimpan dokumen perizinan yang diunggah saat pendaftaran.* |
||||
...
| *C14* | *PengajuanMitra* | *idPengajuan, status, tglPengajuan* | *validasiKelengkapan(), simpanPengajuan()* |
| *C15*|*DokumenVerifikasi*|*idDokumen, jenisDokumen*|*unggahDokumen(), validasiFormat()*|
...
| :--- | :--- | :--- |
| *C14* | *PengajuanMitra* | *Menyimpan data & status pengajuan pendaftaran mitra restoran.* |
| *C16* | *Admin* | *Meninjau dan memutuskan status pengajuan mitra restoran.* |
| *C17* | *NotifikasiEmail* | *Mengirim notifikasi hasil verifikasi ke email restoran.* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C14* | *PengajuanMitra* | *status, alasanPenolakan* | *setujui(), tolak(alasan)* |
| *C16* | *Admin* | *idAdmin, nama, emailAdmin* | *tinjauPengajuan()* |
| *C17* |*NotifikasiEmail*|*penerima, isiPesan, jenis*|*kirimEmail()*|
...
| *C02* | *Restoran* | *Menyimpan data profil restoran yang mengelola antrean.* |
| *C04* | *Antrean* | *Menyimpan koleksi antrean pelanggan pada suatu restoran, status urutan antrean, serta data pesanan pre-order jika ada.* |
| *C06* | *Pesanan* | *Menyimpan detail data pesanan.* |
| *C18* | *Kelola Antrean* | *Mengelola alur pemrosesan dequeue manual/otomatis dan pembaruan status antrean.* |
| *C19* | *Konfirmasi Dequeue* | *Antarmuka pengguna berupa pop-up untuk mengonfirmasi atau membatalkan proses dequeue* |
| *C20* | *Dashboard Antrean* | *Antarmuka pengguna untuk menampilkan daftar antrean restoran dan melakukan dequeue.* |
...
| *C04* | *Antrean* | *antreanId, restoranId, status* | *getFrontCustomer(), dequeueCustomer(), getPesananPreOrder()* |
| *C06* | *Pesanan* | *pesananId, daftarItem, isPreOrder* | *getDetailPesanan()* |
| *C18* | *Kelola Antrean* | *timer* | *getAntrean()* | *handleViewDashboard(), handleDequeue(), handleCancelDequeue(), startNoShowTimer(), processAutoDequeue()* |
| *C19* | *Konfirmasi Dequeue* | *message* | *showConfirmationModal(), hideModal(), onConfirm(), onCancel()* |
| *C20* | *Dashboard Antrean* | *queueListUI* | *displayDashboard(antrean: Antrean), dequeue()* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C02* | *Restoran* | *Menyimpan data profil dan identitas restoran yang mengelola antrean.* |
| *C21* | *Kuota* | *Menyimpan data konfigurasi kuota maksimum antrean dan ketersediaan meja.* |
| *C22* | *Pengaturan Kuota Controller* | *Mengelola validasi input serta penyimpanan data.* |
| *C23* | *Pengaturan Kuota* | *Antarmuka pengguna untuk menampilkan serta menerima input pengaturan kuota dan meja.* |
...
| *C21* | *Kuota* | *kuotaMaksimum, kapasitasMeja, statusAntrean* | *updateKapasitas(), isAntreanTutup()* |
| *22* | *Pengaturan Kuota Controller* | *kuotaInput, mejaInput* | *displaySettings(), onSaveSettings(), showErrorPeringatan()* |
| *23* | *Pengaturan Kuota* | *-* | *handleViewSettings(), handleSaveSettings(), validateInput()* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C02* | *Restoran* | *Menyimpan data profil dan identitas restoran yang memiliki serta mengelola daftar menu makanan.* |
| *C03* | *Menu* | *Menyimpan data entitas item menu makanan, harga, ketersediaan stok, serta informasi ketersediaannya.* |
| *C24* | *Pengaturan Menu* | *Antarmuka pengguna untuk menampilkan daftar menu serta formulir tambah/edit menu* |
| *C25* | *Kelola Menu Controller* | *Mengelola logika bisnis pemrosesan data menu dan pembaruan stok.* |
...
| *C24* | *Pengaturan Menu* | *menuInput, stokInput, hargaInput* | *displayDaftarMenu(), showFormTambahMenu(), onSaveMenu(), onDeleteMenu()* |
| *C25* | *Kelola Menu Controller* | *...* | *handleFetchMenu(), handleAddMenu(), handleUpdateMenu(), handleDeleteMenu()* |
...
| *C20* | *Dashboard Antrean* | *Antarmuka pengguna untuk menampilkan daftar antrean restoran.* |
| *...* | *...* | *...* |

#### Diagram Kelas

<p align="center">
<img alt="Class Diagram UC09" src="./assets/diagram/Diagram Kelas-UC-09.drawio.png" width="70%">
</p>
<p align="center">
...
| *C20* | *Dashboard Antrean* | *daftarAntrean, statusAntrean* | *displayQueue(), updateQueueStatus()* |
| *...* | *...* | *...* | *...* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C01* | *Pelanggan* | *Menyimpan data identitas pelanggan.* |
| *C02* | *Restoran* | *Menyimpan data identitas restoran.* |
| *C16* | *Admin* | *Menyimpan data identitas admin.* |
| *C26* | *Autentikasi Controller* | *Menyimpan username dan password.* |
| *...* | *...* | *...* |

#### Diagram Kelas

<p align="center">
<img alt="Class Diagram UC09" src="./assets/diagram/Diagram Kelas-UC-10.drawio.png" width="70%">
</p>
<p align="center">
...
| *C16* | *Admin* | *idAdmin, idAkun, namaAdmin* | *accountRegister()* |
| *C26* | *Autentikasi Controller* | *akunId, username, password* | *createAccount(), validation()* |
| *...* | *...* | *...* | *...* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C26* | *Autentikasi Controller.* | *Mengeakses dan memverifikasi akun pengguna* |
| *C30* | *Sesi Pengguna* | *Menyimpan informasi sesi pengguna yang sedang aktif* |
| *...* | *...* | *...* |

#### Diagram Kelas

<p align="center">
<img alt="Class Diagram UC09" src="./assets/diagram/Diagram Kelas-UC-011.drawio.png" width="70%">
</p>
<p align="center">
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C26* | *Autentikasi Controller* | *idAkun, username, password* | *validation()* |
| *C30* | *Sesi Pengguna* | *idSesi, token, statusAktif* | *validateSession()* |
| *...* | *...* | *...* | *...* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C27* | *Halaman Profil* | *Antarmuka layar profil pengguna yang menyediakan tombol untuk memicu fungsi keluar akun.* |
| *C28* | *Konfirmasi Logout* | *Dialog konfirmasi yang meminta kepastian pengguna sebelum sesi login diakhiri.* |
| *C29* | *Autentikasi Controller* | *Kontroler sistem yang menangani logika pemutusan sesi dan penghapusan token login pengguna.* |
| *C30* | *Sesi Pengguna* | *Menyimpan token autentikasi aktif, status login, dan mengelola validasi sesi pengguna.* |
| *C31* | *Pengguna* | *Menyimpan kredensial dan hak akses akun (Pelanggan, Restoran, atau Admin) yang sedang login.* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C27* | *Halaman Profil* | *idPengguna, namaUser* | *tekanTombolLogout()* |
| *C28* | *Konfirmasi Logout* | *pesanKonfirmasi* | *konfirmasiYa(), konfirmasiBatal()* |
| *C29* | *Autentikasi Controller* | *tokenManager* | *processLogout(), handleSessionDeletion()* |
| *C30* | *Sesi Pengguna* | *idSesi, token, statusAktif* | *hapusSesi(), validateToken()* |
| *C31* | *Pengguna* | *idPengguna, email, role* | *logout()* |
...
| *C32* | *Keluhan* | *Menyimpan isi, waktu, dan status keluhan pelanggan.* |
||||
...
| *C32* | *Keluhan* | *idKeluhan, isiKeluhan, waktuKirim, status* | *simpanKeluhan()* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C16* | *Admin* | *Aktor yang meninjau daftar keluhan pelanggan.* |
| *C32* | *Keluhan* | *Menyimpan isi, waktu, dan status keluhan pelanggan.* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C16* | *Admin* | *idAdmin, nama* |
| *C32* | *Keluhan* | *status* | *lihatKeluhan()* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C02* | *Restoran* | *Menyimpan data profil mitra restoran, status operasional, dan status kemitraan.* |
| *C16* | *Admin* | *Menyimpan data profil administrator yang memicu aksi penghapusan restoran.* |
| *C33* | *Dashboard Kelola Restoran* | *Antarmuka layar admin yang menampilkan daftar seluruh restoran mitra terdaftar.* |
| *C34* | *Konfirmasi Hapus Restoran* | *Dialog konfirmasi untuk memastikan keputusan admin sebelum menghapus data restoran.* |
| *C35* | *Kelola Data Restoran* | *Kontroler sistem yang mengeksekusi logika bisnis penonaktifan dan penghapusan data restoran dari database.* |
...
| *C16* | *Admin* | *idAdmin, namaAdmin* | *konfirmasiPenghapusan()* |
| *C33* | *Dashboard Kelola Restoran* | *daftarRestoran, kataKunci* | *pilihRestoran(), klikHapusRestoran()* |
| *C34* | *Konfirmasi Hapus Restoran* | *idRestoran, pesanPeringatan* | *setujuiPenghapusan(), batalHapus()* |
| *C35* | *Kelola Data Restoran* | *idRestoran* | *hapusDataRestoran(), nonaktifkanRelasiMenu()* |
