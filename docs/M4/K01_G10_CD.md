...
| *C07* | *MetodePembayaranController* | *idPembayaran, batasWaktuBayar, statusPembayaran* | *buatTagihan(), verifikasiPembayaran(), cekTimeout()* |
...
| *C10* | *Pemantau Antrean Controller* | *Kontroler sistem yang memproses pembacaan data antrean dan memperbarui tampilan status antrean pelanggan.* |
| *C11* | *Halaman Status Antrean* | *Antarmuka layar yang digunakan pelanggan untuk melihat informasi status urutan antrean secara real-time.* |
...
| *C10* | *Pemantau Antrean Controller* | *idAntrean* | *getStatusAntrean(), updateTampilanAntrean()* |
| *C11* | *Halaman Status Antrean* | *idAntrean, statusAntrean, sisaAntrean* | *tampilkanStatusAntrean(), renderData()* |
...
| *C12* | *PengajuanMitraController* | *Menyimpan data & status pengajuan pendaftaran mitra restoran.* |
| *C13* | *DokumenVerifikasi* | *Menyimpan dokumen perizinan yang diunggah saat pendaftaran.* |
||||
...
| :--- | :--- | :--- |
| *C12* | *PengajuanMitraController* | *Menyimpan data & status pengajuan pendaftaran mitra restoran.* |
| *C14* | *Admin* | *Meninjau dan memutuskan status pengajuan mitra restoran.* |
| *C15* | *NotifikasiEmail* | *Mengirim notifikasi hasil verifikasi ke email restoran.* |
...
| *C16* | *KelolaAntreanController* | *Mengelola alur pemrosesan dequeue manual/otomatis dan pembaruan status antrean.* |
| *C17* | *KonfirmasiDequeue* | *Antarmuka pengguna berupa pop-up untuk mengonfirmasi atau membatalkan proses dequeue* |
| *C18* | *KelolaAntrean* | *Antarmuka pengguna untuk menampilkan daftar antrean restoran dan melakukan dequeue.* |
...
| *C16* | *KelolaAntreanController* | *timer* | *getAntrean()* | *handleViewDashboard(), handleDequeue(), handleCancelDequeue(), startNoShowTimer(), processAutoDequeue()* |
| *C17* | *KonfirmasiDequeue* | *message* | *showConfirmationModal(), hideModal(), onConfirm(), onCancel()* |
| *C18* | *KelolaAntrean* | *queueListUI* | *displayDashboard(antrean: Antrean), dequeue()* |
...
| *C20* | *Kuota* | *Menyimpan data konfigurasi kuota maksimum antrean dan ketersediaan meja.* |
| *C21* | *PengaturanKuotaController* | *Mengelola validasi input serta penyimpanan data.* |
| *C22* | *PengaturanKuota* | *Antarmuka pengguna untuk menampilkan serta menerima input pengaturan kuota dan meja.* |
...
| *C22* | *PengaturanKuota* | *-* | *handleViewSettings(), handleSaveSettings(), validateInput()* |
...
| *C23* | *PengaturanMenu* | *Antarmuka pengguna untuk menampilkan daftar menu serta formulir tambah/edit menu* |
| *C24* | *KelolaMenuController* | *Mengelola logika bisnis pemrosesan data menu dan pembaruan stok.* |
...
| *C14* | *Admin* | *Menyimpan data identitas admin.* |
| *C28* | *Autentikasi Controller* | *Menyimpan username dan password.* |
| *...* | *...* | *...* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C26* | *Halaman Profil* | *Antarmuka layar profil pengguna yang menyediakan tombol untuk memicu fungsi keluar akun.* |
| *C27* | *Konfirmasi Logout* | *Dialog konfirmasi yang meminta kepastian pengguna sebelum sesi login diakhiri.* |
| *C28* | *Autentikasi Controller* | *Kontroler sistem yang menangani logika pemutusan sesi dan penghapusan token login pengguna.* |
| *C29* | *Sesi Pengguna* | *Menyimpan token autentikasi aktif, status login, dan mengelola validasi sesi pengguna.* |
| *C30* | *Pengguna* | *Menyimpan kredensial dan hak akses akun (Pelanggan, Restoran, atau Admin) yang sedang login.* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C26* | *Halaman Profil* | *idPengguna, namaUser* | *tekanTombolLogout()* |
| *C27* | *Konfirmasi Logout* | *pesanKonfirmasi* | *konfirmasiYa(), konfirmasiBatal()* |
| *C28* | *Autentikasi Controller* | *tokenManager* | *processLogout(), handleSessionDeletion()* |
| *C29* | *Sesi Pengguna* | *idSesi, token, statusAktif* | *hapusSesi(), validateToken()* |
...
| *C14* | *Admin* | *Menyimpan data profil administrator yang memicu aksi penghapusan restoran.* |
| *C32* | *Dashboard Kelola Restoran* | *Antarmuka layar admin yang menampilkan daftar seluruh restoran mitra terdaftar.* |
| *C33* | *Konfirmasi Hapus Restoran* | *Dialog konfirmasi untuk memastikan keputusan admin sebelum menghapus data restoran.* |
| *C34* | *Kelola Data Restoran* | *Kontroler sistem yang mengeksekusi logika bisnis penonaktifan dan penghapusan data restoran dari database.* |
...
| *C32* | *Dashboard Kelola Restoran* | *daftarRestoran, kataKunci* | *pilihRestoran(), klikHapusRestoran()* |
| *C33* | *Konfirmasi Hapus Restoran* | *idRestoran, pesanPeringatan* | *setujuiPenghapusan(), batalHapus()* |
| *C34* | *Kelola Data Restoran* | *idRestoran* | *hapusDataRestoran(), nonaktifkanRelasiMenu()* |
