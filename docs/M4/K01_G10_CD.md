...
| *C10* | *RiwayatTransaksi* | *Menyimpan catatan transaksi, jumlah pembayaran, waktu transaksi, dan status pelunasan yang diterima dari Payment Gateway. (Entity Class)* |
| *C11* | *TiketAntrean* | *Mengelola ID tiket, nomor urut panggilan, tipe antrean, waktu penerbitan, status antrean, alokasi meja, dan estimasi waktu tunggu. (Entity Class)* |
