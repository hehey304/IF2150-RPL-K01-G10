...
| *C26* | *Akun* | *Menyimpan username dan password* |
| *...* | *...* | *...* |
...
| *C26* | *Akun* | *akunId, username, password* | *createAccount(), validation()* |
| *...* | *...* | *...* | *...* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C26* | *Akun* | *Mengakses dan melihat status antrean pada dashboard antrean.* |
| *...* | *...* | *...* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C26* | *Akun* | *idAkun, username, password* | *validation()* |
| *...* | *...* | *...* | *...* |
